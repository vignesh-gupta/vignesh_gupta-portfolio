...
function Ft(s) {
  return /^_type\s*==\s*['"$]\w+['"]?\s*$/.test(s.trim());
}
function Dt(s, e) {
  const r = s.by.map((n) => {
  ...
  return r.every((n, a) => n === s.by[a]) ? s : { ...s, by: r };
}
function Nt(s, e) {
  const r = Je(e);
  let n = s;
...
function kt(s, e) {
  let r = s.type;
  for (; r; ) {
    if (r.name === e || (!r.type && r.jsonType === e)) return !0;
    r = r.type;
  }
  return !1;
}
...
function Yt(s) {
  const {
      childItemId: e,
      error: r,
      filterIsSimpleTypeConstraint: n,
      hasMaxItems: a,
      hasSearchQuery: d,
      isActive: i,
      isLazyLoading: c,
      ...
      onRetry: g,
      paneTitle: u,
      searchInputElement: b,
      showIcons: T,
    } = s,
    E = ee(),
    { collapsed: L } = nt(),
    { collapsed: p, index: _ } = ye(),
    [j, S] = o.useState(!1),
    C = o.useCallback(() => {
      l || c || !j || I();
    }, [c, l, I, j]);
...
const Ut = [],
  de = { error: null, onRetry: void 0, result: null },
  Ht = { result: null, error: null };
function Gt(s) {
  const {
      filter: e,
      params: r,
    ...
    i = ut({ ...se, apiVersion: d || se.apiVersion }),
    c = ee(),
    [l, m] = o.useState(de),
    { onRetry: v, error: y, result: I } = l,
    g = I == null ? void 0 : I.documents,
    u = o.useMemo(() => (g ? Mt(g) : Ut), [g]),
    [b, T] = o.useState(!1),
    [E, L] = o.useState(!1),
    [p, _] = o.useState(!1),
    j = o.useMemo(() => Le(e, r), [e, r]),
    S = I === null && !y,
    C = (g == null ? void 0 : g.length) === J,
    A = o.useCallback(() => {
      S || E || p || _(!0);
    }, [S, E, p]),
    N = o.useCallback(
      (h) => {
        ...
        const O =
          ((M = (P = h.result) == null ? void 0 : P.documents) == null
            ? void 0
            : M.length) || 0;
        if (!h.error && (h == null ? void 0 : h.result) === null && p) {
          T(!0);
          return;
        }
        if (
          (O < ie && O !== 0 && !p && L(!0),
          (h == null ? void 0 : h.result) === null)
        ) {
          m((R) => ({ ...(R.error ? h : R) }));
          return;
        }
    ...
    w = o.useMemo(() => {
      ...
      return zt({
        ...
        xe((f) => ({ result: { documents: f }, error: null })),
        mt(Ht),
        re((f) =>
...
function en(s) {
  const e = o.useRef(s);
  return ft(e.current, s) || (e.current = s), e.current;
}
const tn = (s) => {
    const { menuItems: e, sortOrderRaw: r, layout: n } = s;
    return e == null
      ? void 0
      : e.map((a) => {
          var d, i, c, l;
          return (d = a.params) != null && d.layout
            ? {
                ...a,
                selected: n === ((i = a.params) == null ? void 0 : i.layout),
              }
            : (c = a == null ? void 0 : a.params) != null && c.by
            ? {
                ...a,
                selected: yt(
                  r == null ? void 0 : r.by,
  ...
  on = o.memo(function (e) {
    const {
      ...
      { apiVersion: E, defaultOrdering: L = Z, filter: p } = b,
      _ = en(b.params || At),
      j = i.source,
      ...
      we = Ft(p),
      {
        ...
        filter: p,
        params: _,
        searchQuery: w == null ? void 0 : w.trim(),
        sortOrder: Ee,
      }),
      De = o.useMemo(
        ...
        children: [
          ...
          t.jsx(
            Yt,
            {
              childItemId: r,
              error: Pe,
              filterIsSimpleTypeConstraint: we,
              hasMaxItems: Ce,
              hasSearchQuery: !!w,
              isActive: a,
              isLazyLoading: Ae,
